...
TABLE_NAME = "google_ads_raw"

# ID FIXO DO ARQUIVO NO DRIVE (Substitua pelo ID do seu arquivo de Google Ads)
DRIVE_FILE_ID = "1ljfh25SSOr6cLnCpUUvfeVpaLg-LM8It"
...
def run_extraction():
    try:
        ...
        return {
            "status": "success", 
            "message": f"Extração Google Ads concluída. Tabela {TABLE_NAME} atualizada."
        }, 200

    except Exception as e:
        print(f"Erro Crítico Google Ads: {str(e)}")
